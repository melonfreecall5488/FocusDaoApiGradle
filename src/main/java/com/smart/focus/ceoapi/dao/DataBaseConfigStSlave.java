...
@Configuration
public class DataBaseConfigStSlave {

	@Bean(name = "smartFactoryStSlave")
	...
	@Bean(name = "JdbcTemplateSmartStSlave")
	public JdbcTemplate jdbcTemplate1(@Qualifier("smartFactoryStSlave") DataSource ds) {
