 ...
 * 
 * 
 * <p>AccountDeterminationDebtorGroupCode complex type에 대한 Java 클래스입니다.
 * 
 * <p>다음 스키마 단편이 이 클래스에 포함되는 필요한 콘텐츠를 지정합니다.
 * 
 * <pre>
 * &lt;complexType name="AccountDeterminationDebtorGroupCode"&gt;
 *   &lt;simpleContent&gt;
 *     &lt;extension base="&lt;http://sap.com/xi/AP/FinancialAccounting/Global&gt;AccountDeterminationDebtorGroupCode.Content"&gt;
...
@XmlType(name = "AccountDeterminationDebtorGroupCode", namespace = "http://sap.com/xi/AP/FinancialAccounting/Global", propOrder = {
    "value"
})
public class AccountDeterminationDebtorGroupCode {
