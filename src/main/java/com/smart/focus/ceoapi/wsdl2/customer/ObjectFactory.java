 ...
 * generated in the com.smart.focus.ceoapi.wsdl2.customer package.
 * <p>
...
public class ObjectFactory {
    ...
    private final static QName _CustomerByCommunicationDataQuerySync_QNAME = new QName(
            "http://sap.com/xi/SAPGlobal20/Global", "CustomerByCommunicationDataQuery_sync");
    private final static QName _CustomerByCommunicationDataResponseSync_QNAME = new QName(
            "http://sap.com/xi/SAPGlobal20/Global", "CustomerByCommunicationDataResponse_sync");
    private final static QName _CustomerByElementsQuerySync_QNAME = new QName("http://sap.com/xi/SAPGlobal20/Global",
            "CustomerByElementsQuery_sync");
    private final static QName _CustomerByElementsResponseSync_QNAME = new QName("http://sap.com/xi/SAPGlobal20/Global",
            "CustomerByElementsResponse_sync");
    private final static QName _CustomerByIdentificationQuerySync_QNAME = new QName(
            "http://sap.com/xi/SAPGlobal20/Global", "CustomerByIdentificationQuery_sync");
    private final static QName _CustomerByIdentificationResponseSync_QNAME = new QName(
            "http://sap.com/xi/SAPGlobal20/Global", "CustomerByIdentificationResponse_sync");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema
     * derived classes for package: com.smart.focus.ceoapi.wsdl2.customer
     * 
     */
     ...
     * }{@code <}{@link CustomerByCommunicationDataQueryMessageSync }{@code >}
     * 
     * @param value
     *              Java instance representing xml element's value.
     * @return
     *         the new instance of {@link JAXBElement
     *         }{@code <}{@link CustomerByCommunicationDataQueryMessageSync
     *         }{@code >}
     */
    @XmlElementDecl(namespace = "http://sap.com/xi/SAPGlobal20/Global", name = "CustomerByCommunicationDataQuery_sync")
    public JAXBElement<CustomerByCommunicationDataQueryMessageSync> createCustomerByCommunicationDataQuerySync(
            CustomerByCommunicationDataQueryMessageSync value) {
        return new JAXBElement<CustomerByCommunicationDataQueryMessageSync>(_CustomerByCommunicationDataQuerySync_QNAME,
                CustomerByCommunicationDataQueryMessageSync.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement
     * }{@code <}{@link CustomerResponseMessageSync }{@code >}
     * 
     * @param value
     *              Java instance representing xml element's value.
     * @return
    ...
    public JAXBElement<CustomerResponseMessageSync> createCustomerByCommunicationDataResponseSync(
            CustomerResponseMessageSync value) {
        return new JAXBElement<CustomerResponseMessageSync>(_CustomerByCommunicationDataResponseSync_QNAME,
                CustomerResponseMessageSync.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement
     * }{@code <}{@link CustomerByElementsQueryMessageSync }{@code >}
     * 
     * @param value
     *              Java instance representing xml element's value.
     * @return
    ...
    public JAXBElement<CustomerByElementsQueryMessageSync> createCustomerByElementsQuerySync(
            CustomerByElementsQueryMessageSync value) {
        return new JAXBElement<CustomerByElementsQueryMessageSync>(_CustomerByElementsQuerySync_QNAME,
                CustomerByElementsQueryMessageSync.class, null, value);
    }
    ...
    public JAXBElement<CustomerResponseMessageSync> createCustomerByElementsResponseSync(
            CustomerResponseMessageSync value) {
        return new JAXBElement<CustomerResponseMessageSync>(_CustomerByElementsResponseSync_QNAME,
                CustomerResponseMessageSync.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement
     * }{@code <}{@link CustomerByIdentificationQueryMessageSync }{@code >}
     * 
     * @param value
     *              Java instance representing xml element's value.
     * @return
    ...
    public JAXBElement<CustomerByIdentificationQueryMessageSync> createCustomerByIdentificationQuerySync(
            CustomerByIdentificationQueryMessageSync value) {
        return new JAXBElement<CustomerByIdentificationQueryMessageSync>(_CustomerByIdentificationQuerySync_QNAME,
                CustomerByIdentificationQueryMessageSync.class, null, value);
    }
    ...
    public JAXBElement<CustomerResponseMessageSync> createCustomerByIdentificationResponseSync(
            CustomerResponseMessageSync value) {
        return new JAXBElement<CustomerResponseMessageSync>(_CustomerByIdentificationResponseSync_QNAME,
                CustomerResponseMessageSync.class, null, value);
    }
