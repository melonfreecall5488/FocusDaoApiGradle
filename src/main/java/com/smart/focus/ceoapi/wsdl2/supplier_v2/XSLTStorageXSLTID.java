...
@XmlType(name = "XSLTStorageXSLTID", namespace = "http://sap.com/xi/AP/FO/PriceAndTax/Global", propOrder = {
    "value"
})
public class XSLTStorageXSLTID {
