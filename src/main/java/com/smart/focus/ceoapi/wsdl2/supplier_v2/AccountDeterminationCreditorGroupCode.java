...
@XmlType(name = "AccountDeterminationCreditorGroupCode", namespace = "http://sap.com/xi/AP/FinancialAccounting/Global", propOrder = {
    "value"
})
public class AccountDeterminationCreditorGroupCode {
