...
/**
 * <p>ConsumptionCostCBOUpdateRequest complex type에 대한 Java 클래스입니다.
 * 
 * <p>다음 스키마 단편이 이 클래스에 포함되는 필요한 콘텐츠를 지정합니다.
 * 
 * <pre>
 * &lt;complexType name="ConsumptionCostCBOUpdateRequest"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="Item" type="{http://0027131779-one-off.sap.com/YHXNC1Z4Y_}ConsumptionCostCBOUpdateRequestItem" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "ConsumptionCostCBOUpdateRequest", propOrder = {
    "sapuuid",
    "ownerID",
    "siteID",
    "costCenterID",
...
public class ConsumptionCostCBOUpdateRequest {
    ...
    protected List<ConsumptionCostCBOUpdateRequestItem> item;
     ...
     * {@link ConsumptionCostCBOUpdateRequestItem }
     * 
     * 
     */
    public List<ConsumptionCostCBOUpdateRequestItem> getItem() {
        if (item == null) {
            item = new ArrayList<ConsumptionCostCBOUpdateRequestItem>();
        }
        return this.item;
    }
