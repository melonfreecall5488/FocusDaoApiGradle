...
/**
 * <p>SupplierByElementsResponseSupplierAddressInformation complex type에 대한 Java 클래스입니다.
 * 
 * <p>다음 스키마 단편이 이 클래스에 포함되는 필요한 콘텐츠를 지정합니다.
 * 
 * <pre>
 * &lt;complexType name="SupplierByElementsResponseSupplierAddressInformation"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="Address" type="{http://sap.com/xi/A1S/Global}SupplierByElementsResponseSupplierAddress" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "SupplierByElementsResponseSupplierAddressInformation", namespace = "http://sap.com/xi/A1S/Global", propOrder = {
    "uuid",
    "currentAddressSnapshotUUID",
    "addressUsage",
    "address"
})
public class SupplierByElementsResponseSupplierAddressInformation {
    ...
    protected SupplierByElementsResponseSupplierAddress address;
     ...
     * @return
     *     possible object is
     *     {@link SupplierByElementsResponseSupplierAddress }
     *     
     */
    public SupplierByElementsResponseSupplierAddress getAddress() {
        return address;
    }
     ...
     *     
     */
    public void setAddress(SupplierByElementsResponseSupplierAddress value) {
        this.address = value;
    }
