...
/**
 * <p>MaterialByElementsResponseMaterialValuation complex type에 대한 Java 클래스입니다.
 * 
 * <p>다음 스키마 단편이 이 클래스에 포함되는 필요한 콘텐츠를 지정합니다.
 * 
 * <pre>
 * &lt;complexType name="MaterialByElementsResponseMaterialValuation"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="BusinessResidenceID" type="{http://sap.com/xi/AP/Common/GDT}OrganisationalCentreID" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "MaterialByElementsResponseMaterialValuation", namespace = "http://sap.com/xi/A1S/Global", propOrder = {
    "lifeCycleStatusCode",
    "companyID",
    "businessResidenceID"
})
public class MaterialByElementsResponseMaterialValuation {
    ...
    @XmlElement(name = "BusinessResidenceID")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
    protected String businessResidenceID;
    ...
    /**
     * businessResidenceID 속성의 값을 가져옵니다.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * businessResidenceID 속성의 값을 설정합니다.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setBusinessResidenceID(String value) {
        this.businessResidenceID = value;
    }
