...
@XmlType(name = "WithholdingTaxRecipientTypeCode", namespace = "http://sap.com/xi/AP/FO/WithholdingTax/Global", propOrder = {
    "value"
})
public class WithholdingTaxRecipientTypeCode {
