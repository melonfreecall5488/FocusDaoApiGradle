...
/**
 * <p>GoodsMovementCBOCreateRequest complex type에 대한 Java 클래스입니다.
 * 
 * <p>다음 스키마 단편이 이 클래스에 포함되는 필요한 콘텐츠를 지정합니다.
 * 
 * <pre>
 * &lt;complexType name="GoodsMovementCBOCreateRequest"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="Item" type="{http://0027131779-one-off.sap.com/YHXNC1Z4Y_}GoodsMovementCBOCreateRequestItem" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "GoodsMovementCBOCreateRequest", propOrder = {
    "ownerID",
    "transitNO",
    "shopID",
    "shopNM",
...
public class GoodsMovementCBOCreateRequest {
    ...
    protected List<GoodsMovementCBOCreateRequestItem> item;
     ...
     * {@link GoodsMovementCBOCreateRequestItem }
     * 
     * 
     */
    public List<GoodsMovementCBOCreateRequestItem> getItem() {
        if (item == null) {
            item = new ArrayList<GoodsMovementCBOCreateRequestItem>();
        }
        return this.item;
    }
