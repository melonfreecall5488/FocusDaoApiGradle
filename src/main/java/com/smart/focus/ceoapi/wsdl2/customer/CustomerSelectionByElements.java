...
/**
 * <p>
 * CustomerSelectionByElements complex type에 대한 Java 클래스입니다.
 * 
 * <p>
...
public class CustomerSelectionByElements {
    ...
    protected String selectionByCreatedSinceDate;
    @XmlElement(name = "SelectionByChangedSinceDate")
    protected String selectionByChangedSinceDate;
     ...
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the
     * selectionByContactPersonWorkplaceEmailURI property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * 
    ...
    /**
     * Gets the value of the selectionBySalesArrangementSalesOrganisationID
     * property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     ...
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the
     * selectionBySalesArrangementSalesOrganisationID property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * 
     ...
     * 
     */
    public String getSelectionByCreatedSinceDate() {
     ...
     * 
     */
    public void setSelectionByCreatedSinceDate(String value) {
     ...
     * 
     */
    public String getSelectionByChangedSinceDate() {
     ...
     * 
     */
    public void setSelectionByChangedSinceDate(String value) {
     ...
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the
     * selectionByCreationIdentityID property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * 
     ...
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the
     * selectionByLastChangeIdentityID property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * 
     ...
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the
     * selectionByGroupwareSubscriptionEmployeeUUID property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * 
     ...
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the
     * selectionByResponsibleEmployeeUUID property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * 
     ...
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the
     * selectionByCreationDateTime property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * 
     ...
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the
     * selectionByLastChangeDateTime property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * 
