...
/**
 * <p>ConsumptionCostCBOCreateRequestMessage_sync complex type에 대한 Java 클래스입니다.
 * 
 * <p>다음 스키마 단편이 이 클래스에 포함되는 필요한 콘텐츠를 지정합니다.
 * 
 * <pre>
 * &lt;complexType name="ConsumptionCostCBOCreateRequestMessage_sync"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="BasicMessageHeader" type="{http://sap.com/xi/AP/Common/GDT}BusinessDocumentBasicMessageHeader"/&gt;
 *         &lt;element name="ConsumptionCostCBO" type="{http://0027131779-one-off.sap.com/YHXNC1Z4Y_}ConsumptionCostCBOCreateRequest"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "ConsumptionCostCBOCreateRequestMessage_sync", propOrder = {
    "basicMessageHeader",
    "consumptionCostCBO"
})
public class ConsumptionCostCBOCreateRequestMessageSync {
    ...
    protected ConsumptionCostCBOCreateRequest consumptionCostCBO;
     ...
     * @return
     *     possible object is
     *     {@link ConsumptionCostCBOCreateRequest }
     *     
     */
    public ConsumptionCostCBOCreateRequest getConsumptionCostCBO() {
     ...
     *     
     */
    public void setConsumptionCostCBO(ConsumptionCostCBOCreateRequest value) {
