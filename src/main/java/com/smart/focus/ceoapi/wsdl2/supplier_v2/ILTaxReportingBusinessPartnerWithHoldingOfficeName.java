...
@XmlType(name = "IL_TaxReportingBusinessPartnerWithHoldingOfficeName", namespace = "http://sap.com/xi/AP/Globalization", propOrder = {
    "value"
})
public class ILTaxReportingBusinessPartnerWithHoldingOfficeName {
