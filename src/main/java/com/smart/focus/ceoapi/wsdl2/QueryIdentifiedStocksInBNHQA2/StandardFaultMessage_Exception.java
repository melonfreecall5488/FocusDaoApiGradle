...
public class StandardFaultMessage_Exception extends Exception {
    ...
    private com.smart.focus.ceoapi.wsdl2.QueryIdentifiedStocksInBNHQA2.StandardFaultMessage faultInfo;
    ...
    public StandardFaultMessage_Exception(String message,
            com.smart.focus.ceoapi.wsdl2.QueryIdentifiedStocksInBNHQA2.StandardFaultMessage standardFaultMessage) {
        super(message);
    ...
    public com.smart.focus.ceoapi.wsdl2.QueryIdentifiedStocksInBNHQA2.StandardFaultMessage getFaultInfo() {
