 ...
 * 
 * 
 * <p>TaxPayerCategoryCode complex type에 대한 Java 클래스입니다.
 * 
 * <p>다음 스키마 단편이 이 클래스에 포함되는 필요한 콘텐츠를 지정합니다.
 * 
 * <pre>
 * &lt;complexType name="TaxPayerCategoryCode"&gt;
 *   &lt;simpleContent&gt;
 *     &lt;extension base="&lt;http://sap.com/xi/AP/Common/GDT&gt;TaxPayerCategoryCode.Content"&gt;
...
@XmlType(name = "TaxPayerCategoryCode", namespace = "http://sap.com/xi/AP/Common/GDT", propOrder = {
    "value"
})
public class TaxPayerCategoryCode {
