...
/**
 * <p>MDR_SiteLogisticTaskCreateRequest complex type에 대한 Java 클래스입니다.
 * 
 * <p>다음 스키마 단편이 이 클래스에 포함되는 필요한 콘텐츠를 지정합니다.
 * 
 * <pre>
 * &lt;complexType name="MDR_SiteLogisticTaskCreateRequest"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="DetailTable" type="{http://0027131779-one-off.sap.com/Y57MOATJY_}MDR_SiteLogisticTaskCreateRequestDetailTable" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "MDR_SiteLogisticTaskCreateRequest", propOrder = {
    "tnoustraSales",
    "tnoustraOrd",
    "tnoSales",
    "tcdStatus",
...
public class MDRSiteLogisticTaskCreateRequest {
    ...
    protected List<MDRSiteLogisticTaskCreateRequestDetailTable> detailTable;
     ...
     * {@link MDRSiteLogisticTaskCreateRequestDetailTable }
     * 
     * 
     */
    public List<MDRSiteLogisticTaskCreateRequestDetailTable> getDetailTable() {
        if (detailTable == null) {
            detailTable = new ArrayList<MDRSiteLogisticTaskCreateRequestDetailTable>();
        }
