...
/**
 * <p>CustomerResponseMessage_sync complex type에 대한 Java 클래스입니다.
 * 
 * <p>다음 스키마 단편이 이 클래스에 포함되는 필요한 콘텐츠를 지정합니다.
 * 
 * <pre>
 * &lt;complexType name="CustomerResponseMessage_sync"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="Customer" type="{http://sap.com/xi/A1S/Global}CustomerReponseCustomer" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "CustomerResponseMessage_sync", propOrder = {
    "customer",
    "processingConditions",
    "log"
})
public class CustomerResponseMessageSync {

    @XmlElement(name = "Customer")
    protected List<CustomerReponseCustomer> customer;
     ...
     * {@link CustomerReponseCustomer }
     * 
     * 
     */
    public List<CustomerReponseCustomer> getCustomer() {
        if (customer == null) {
            customer = new ArrayList<CustomerReponseCustomer>();
        }
