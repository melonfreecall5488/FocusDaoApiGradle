...
/**
 * <p>CustomerReponseCustomerBankDetails complex type에 대한 Java 클래스입니다.
 * 
 * <p>다음 스키마 단편이 이 클래스에 포함되는 필요한 콘텐츠를 지정합니다.
 * 
 * <pre>
 * &lt;complexType name="CustomerReponseCustomerBankDetails"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;group ref="{http://sap.com/xi/AP/Globalization}CustomerReponseCustomerBankDetailsExtensionElements"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "CustomerReponseCustomerBankDetails", propOrder = {
    "id",
    "bankUUID",
    "bankInternalID",
    "bankRoutingID",
...
public class CustomerReponseCustomerBankDetails {
    ...
    /**
     * goldenTaxRelevanceIndicator 속성의 값을 가져옵니다.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
    ...
    /**
     * goldenTaxRelevanceIndicator 속성의 값을 설정합니다.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
