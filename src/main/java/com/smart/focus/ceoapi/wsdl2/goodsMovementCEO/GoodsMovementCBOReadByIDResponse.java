...
/**
 * <p>GoodsMovementCBOReadByIDResponse complex type에 대한 Java 클래스입니다.
 * 
 * <p>다음 스키마 단편이 이 클래스에 포함되는 필요한 콘텐츠를 지정합니다.
 * 
 * <pre>
 * &lt;complexType name="GoodsMovementCBOReadByIDResponse"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="Item" type="{http://0027131779-one-off.sap.com/YHXNC1Z4Y_}GoodsMovementCBOReadByIDResponseItem" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "GoodsMovementCBOReadByIDResponse", propOrder = {
    "sapuuid",
    "ownerID",
    "transitNO",
    "shopID",
...
public class GoodsMovementCBOReadByIDResponse {
    ...
    protected List<GoodsMovementCBOReadByIDResponseItem> item;
     ...
     * {@link GoodsMovementCBOReadByIDResponseItem }
     * 
     * 
     */
    public List<GoodsMovementCBOReadByIDResponseItem> getItem() {
        if (item == null) {
            item = new ArrayList<GoodsMovementCBOReadByIDResponseItem>();
        }
        return this.item;
    }
