...
/**
 * <p>SupplierByElementsResponseSupplierContactPerson complex type에 대한 Java 클래스입니다.
 * 
 * <p>다음 스키마 단편이 이 클래스에 포함되는 필요한 콘텐츠를 지정합니다.
 * 
 * <pre>
 * &lt;complexType name="SupplierByElementsResponseSupplierContactPerson"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="WorkplaceTelephone" type="{http://sap.com/xi/A1S/Global}SupplierByElementsReponseSupplierTelephone" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element name="WorkplaceFormattedAddress" type="{http://sap.com/xi/A1S/Global}SupplierByElementsResponseSupplierAddressFormattedAddress" minOccurs="0"/&gt;
 *         &lt;element name="AddressInformation" type="{http://sap.com/xi/A1S/Global}SupplierByElementsReponseSupplierContactPersonAddre" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "SupplierByElementsResponseSupplierContactPerson", namespace = "http://sap.com/xi/A1S/Global", propOrder = {
...
public class SupplierByElementsResponseSupplierContactPerson {
    ...
    protected List<SupplierByElementsReponseSupplierTelephone> workplaceTelephone;
    ...
    protected SupplierByElementsResponseSupplierAddressFormattedAddress workplaceFormattedAddress;
    @XmlElement(name = "AddressInformation")
    protected List<SupplierByElementsReponseSupplierContactPersonAddre> addressInformation;
     ...
     * 
     */
    public List<SupplierByElementsReponseSupplierTelephone> getWorkplaceTelephone() {
        if (workplaceTelephone == null) {
            workplaceTelephone = new ArrayList<SupplierByElementsReponseSupplierTelephone>();
        }
     ...
     *     
     */
    public SupplierByElementsResponseSupplierAddressFormattedAddress getWorkplaceFormattedAddress() {
     ...
     *     
     */
    public void setWorkplaceFormattedAddress(SupplierByElementsResponseSupplierAddressFormattedAddress value) {
     ...
     * 
     */
    public List<SupplierByElementsReponseSupplierContactPersonAddre> getAddressInformation() {
        if (addressInformation == null) {
            addressInformation = new ArrayList<SupplierByElementsReponseSupplierContactPersonAddre>();
        }
