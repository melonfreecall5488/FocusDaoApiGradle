...
/**
 * <p>
 * SelectionByProductionLotDates complex type에 대한 Java 클래스입니다.
 * 
 * <p>
 * 다음 스키마 단편이 이 클래스에 포함되는 필요한 콘텐츠를 지정합니다.
 * 
 * <pre>
 * &lt;complexType name="SelectionByProductionLotDates"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="LowerBoundaryDate" type="{http://sap.com/xi/BASIS/Global}GLOBAL_DateTime" minOccurs="0"/&gt;
 *         &lt;element name="UpperBoundaryDate" type="{http://sap.com/xi/BASIS/Global}GLOBAL_DateTime" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "SelectionByProductionLotDates", propOrder = {
        "inclusionExclusionCode",
        "intervalBoundaryTypeCode",
        "lowerBoundaryDate",
        "upperBoundaryDate"
})
public class SelectionByProductionLotDates {
    ...
    /**
     * lowerBoundaryDate 속성의 값을 가져옵니다.
     * 
     * @return
     *         possible object is
    ...
    /**
     * lowerBoundaryDate 속성의 값을 설정합니다.
     * 
     * @param value
     *              allowed object is
     *              {@link XMLGregorianCalendar }
    ...
    /**
     * upperBoundaryDate 속성의 값을 가져옵니다.
     * 
     * @return
     *         possible object is
     *         {@link XMLGregorianCalendar }
    ...
    /**
     * upperBoundaryDate 속성의 값을 설정합니다.
     * 
     * @param value
     *              allowed object is
     *              {@link XMLGregorianCalendar }
