...
/**
 * <p>ExtSelectionByAmount complex type에 대한 Java 클래스입니다.
 * 
...
public class ExtSelectionByAmount {
     ...
     * This is why there is not a <CODE>set</CODE> method for the selectionByAmount property.
     * 
     * <p>
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the selectionByCurrencyCode property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
